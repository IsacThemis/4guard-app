            ...
            <div className="flex flex-col relative pb-20">
                ...
                <header className="bg-primary text-white p-4 pb-6 rounded-b-[2rem] shadow-md z-10">
                    <div className="flex justify-between items-center">
                        <div>
                            <h1 className="text-2xl font-work-sans font-bold text-white">4-GUARD</h1>
                ...
                <div className="px-4 -mt-8 relative z-20">
                    <div className="bg-white rounded-xl shadow-lg border border-slate-100 p-4 flex justify-between items-center">
                        <div>
                            ...
                            <div className="text-lg font-bold text-slate-800 font-inter">OP-14 (Juan P.)</div>
                        </div>
                        <div className="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-bold font-inter">
                            En Turno
                        </div>
                    </div>
                </div>
                ...
                <div className="flex-1 p-4 mt-2 space-y-4">
                    <h2 className="font-bold text-slate-500 uppercase tracking-widest text-xs ml-2 font-inter">Tareas Asignadas</h2>
                    ...
                    <Link href="/rf/picking/WAV-2026-089" className="block">
                        <div className="bg-white rounded-2xl p-5 border-2 border-primary shadow-sm active:scale-95 transition-transform">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <span className="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wider animate-pulse font-inter">
                                    Alta Prioridad
                                </span>
                            </div>
                            ...
                            <div className="mt-4 flex items-center justify-between text-primary font-bold font-inter">
                    ...
                    {/* Secondary Task */}
                    <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm opacity-70">
                        <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="mt-4 flex items-center justify-between text-slate-400 font-bold font-inter">
                ...
                {/* Fixed Action Button (FAB) for Anomaly */}
